...
from PyQt5.QtWidgets import QBoxLayout, QCheckBox, QComboBox, QFormLayout, QLayout, QListView, QListWidget, QMessageBox, QRadioButton
...
class PyCalcUi(QMainWindow):
    ...
    def _createRadio(self):
        ...
        self.generalLayout.addWidget(self.rb[0])
        self.generalLayout.addWidget(self.rb[1])
        self.generalLayout.addWidget(self.rb[2])
    ...
    def information(self):
        ...
        msg.setInformativeText("Aplikacja ma być ułatwieniem dla osób grających w gry planszowe, rpg i bitewne. Jej zadaniem jest obliczanie prawdopodobieństw uzyskania wskazanych wyników rzutów koścmi oraz dokonywanie symulacji takich rzutów")
    ...
    def showRollResult(self, roller):
        self.setDisplayText(str(roller.roll()[0]))
